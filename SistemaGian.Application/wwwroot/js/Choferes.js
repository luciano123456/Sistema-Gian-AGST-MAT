    ...
    if (!gridChoferes) {
        ...
        gridChoferes = $('#grd_Choferes').DataTable({
            ...
            columns: [
                ...
                <button class='btn btn-sm btneditar btnacciones' type='button' onclick='abrirModalPrecios(${data})' title='Configurar precios'>
                    <i class='fa fa-dollar fa-lg text-success' aria-hidden='true'></i>
                </button>`;
                    },
                    orderable: true,
                    searchable: true,
